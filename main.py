...
PROXY = {
    "scheme": "http",             # পেইড প্রক্সি SOCKS5 হলে "socks5" লিখবেন
    "hostname": "200.118.71.12",  # এখানে প্রক্সির IP বসাবেন
    "port": 8080,                 # এখানে প্রক্সির Port বসাবেন
    # "username": "your_user",    # পেইড প্রক্সির ইউজারনেম থাকলে সামনের # সরিয়ে এখানে বসাবেন
    # "password": "your_pass"     # পেইড প্রক্সির পাসওয়ার্ড থাকলে সামনের # সরিয়ে এখানে বসাবেন
}
